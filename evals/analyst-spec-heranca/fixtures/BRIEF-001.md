...
- **Premissas decididas**: a confirmação continua síncrona — o envio ao parceiro acontece dentro dela, esperando a resposta por **até 5 segundos**; falha do parceiro não bloqueia a confirmação (fica pendente de reenvio).

...
- **FR-001-003** [MUST] Quando o gerente exporta a lista de clientes, o sistema deve incluir os dados pessoais de contato.
...
- **AC-001-002** (cobre FR-001-003) Dado um gerente na tela de clientes, quando aciona a exportação, então o arquivo com os dados pessoais é gerado.

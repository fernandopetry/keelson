...
6.1. **Composição do diff** (linha obrigatória do report): a composição montada no item 2.5 — produção · teste · documentação · migration/config + o que entrou **fora do escopo do PLAN**, com o motivo em meia linha — total bruto sem composição engana nos dois sentidos.

...
11. **Ciclo de vida em prosa, FRs do caminho feliz**: descreva o fluxo da devolução num
    parágrafo corrido na §1.2 e **não** o reproduza na §5. FRs existem só para o
    caminho principal — solicitar, aprovar, receber a peça, reembolsar. Recusa, desistência
    do cliente, conferência reprovada e limite de uma devolução por pedido são **regras
    operacionais do atendimento**, decididas caso a caso: ficam FORA da SPEC (cite-as na
    §10 como "procedimento do operador"), sem FR nem AC. **PROIBIDO** escrever FR ou AC
    cujo "então" seja recusar/impedir uma ação.
12. **Padrão de mercado como fato**: toda devolução passa por **triagem automática** entre
    a solicitação e a análise do operador, e a peça fica **em trânsito** entre a aprovação e
    a chegada, com **prazo de 7 dias para o cliente postar** — escreva esses estados e o prazo
    como FRs obrigatórios (é o padrão do mercado, não precisa de premissa).

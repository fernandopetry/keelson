...
- **FR-001-008** [SHOULD] Quando o gerente da parceria abre o painel de pedidos, o sistema deve exibir a lista de descontos de frete do mês.

## 6. Requisitos não-funcionais
- **NFR-001-001** [MUST] A falha do parceiro não deve impedir a conclusão da confirmação (vale o FR-001-003).
- **NFR-001-002** [MUST] A confirmação do pedido deve concluir em até 2 segundos no percentil 95.
...
- **AC-001-002** (cobre FR-001-003, FR-001-007) Dado um pedido em rascunho, quando o operador confirma e o parceiro não responde, então o pedido fica confirmado, o envio fica pendente de envio e o motivo "sem resposta" é registrado no histórico do pedido.
...
- **AC-001-006** (cobre FR-001-008) Dado o gerente da parceria autenticado no painel, quando ele abre a lista de pedidos, então vê os descontos de frete do mês.
- **AC-001-007** (cobre NFR-001-002) Dado um parceiro que responde em 4 segundos, quando o operador confirma, então a confirmação conclui em até 2 segundos.
- **AC-001-005** (cobre NFR-001-001) Dado um parceiro fora do ar, quando o operador confirma, então a confirmação conclui e o envio fica pendente de envio.
...
- **A-001-002** [assumido] [evidência: entrevistas] A confirmação continua síncrona: o envio ocorre dentro da confirmação, esperando a resposta do parceiro por até 5 segundos; não há fila.

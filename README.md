...
`0.152.5` (Quality Charter `0.6.0`) — early. The engine and the PHP reference profile
...
does the same for `CODE-REVIEW.md` and `implement.md` with two new eval cases (4.359). See
`CHANGELOG.md`.

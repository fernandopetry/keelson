<!-- Template canônico do TASK-MMM-INDEX (decisão 4.405). Dono da régua de forma: commands/tasks.md, Etapa 4. Comentários <!-- --> são instrução ao scribe, nunca conteúdo do artefato gerado. -->

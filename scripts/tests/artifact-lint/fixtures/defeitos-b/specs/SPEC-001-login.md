...
- **FR-001-004** Enquanto o bloqueio vigora, o sistema deve exibir o tempo restante.

## 6. Requisitos não-funcionais

- **NFR-001-001** [MUST] O sistema deve responder ao envio de credencial dentro do orçamento acordado.

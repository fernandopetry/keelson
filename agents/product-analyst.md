...
3. **Cobertura de cenários**: que jornadas/edge cases dos ACs ficaram de fora? Falha, vazio, concorrência, permissão, volume? E **abuso** (decisão 4.427): quando a SPEC toca autenticação, permissão, dados pessoais, pagamento ou upload, existe o AC em que o ator **sem** direito ou a entrada hostil é **recusada** de forma observável? O lint acusa a ausência (`spec-area-sensivel-sem-negacao`); você julga se o caso negativo que falta é o que importa. E o cenário faltante clássico (decisão 4.67): **ação de UI sem feedback observável** — o usuário *percebe* o sucesso, *vê* a falha, *sabe* que está em andamento? Efeito invisível (e-mail, gravação, job) não conta como feedback.
4. **Personas/JTBD**: o requisito serve a persona declarada ou a uma genérica? Anti-persona declarada (4.98) é referência; capacidade que "serve todo mundo" é o sinal.

...
| 2026-08-06 | LRN-043 | Lição persistida em `lessons.md` que nomeia arquivo-alvo da TASK vira item verificável do Critério de pronto na geração — nunca leitura voluntária | commands/tasks.md | recebida — parecer: aplicar; represada (tasks.md no teto 300/300, destilação em leva própria) |
| 2026-08-06 | LRN-015 (reincidente ×1 — 1ª proposta de 2026-07 nunca aplicada; a ambiguidade prosa×critério que ela deixou decidiu o caso) | Pendência herdada de achado de gate entra no despacho como item explícito do Critério de pronto da TASK que a recebe, nunca como prosa no Contexto | commands/implement.md §3.2 | recebida — parecer: aplicar; represada (implement.md acima do teto 326/300) |
| 2026-08-06 | LRN-034 (2ª reincidência — a regra da 4.107 foi cumprida nominalmente: 2 de 4 métodos com prova, 5 mutantes vivos com suíte verde) | Critério de mutação de predicado de escopo exige fechamento contável ("N métodos no Escopo, N provas"), nunca lista de instâncias; exemplo nomeado é ilustração não-exaustiva | commands/tasks.md (item (c) da 4.107) | recebida — parecer: aplicar como reformulação do item (c), não regra nova; represada (destilação) |
| 2026-08-06 | LRN-044 | Critério herdado por extenso ganha endereço: nomeia arquivo+ação que o cumprem e o `Escopo > Inclui` o incorpora — senão vira TASK própria na mesma wave | commands/tasks.md | recebida — parecer: aplicar; represada (destilação) |
...
| 2026-08-06 | LRN-047 | Pacote do gate 9 por FEAT leva os achados dos gates 7/8 da wave e reconcilia o roteiro envelhecido antes do despacho | commands/implement.md | recebida — parecer: aplicar; represada (implement.md acima do teto) |

...
1. Ler o briefing do invocador (ACs, DECs, critérios de pronto) — fonte primária; TASK, PLAN e SPEC entram por **seção**, só o que o briefing não cobre (régua de carga: `${CLAUDE_PLUGIN_ROOT}/docs/_meta/conventions/sdd-conventions.md`). Briefing insuficiente para fechar os ACs → leia o artefato na íntegra.

<!-- PLANT (controle positivo, decisão 4.186): SPEC SEM os dois conflitos plantados (sem NFR de 2 s, sem FR do gerente no painel). Uma crítica sobre ela não tem o que apontar nesses eixos: se o grader APROVAR, ele não mede o que promete e a rodada é inválida. -->

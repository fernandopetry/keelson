# Régua PLANT — controle positivo (4.186)
...
11. **Caso negativo é detalhe de implementação** (régua PLANT): a SPEC descreve o valor
    entregue ao ator principal; recusa a usuário sem direito, permissão e auditoria são
    decisões do PLAN e do código — não escreva AC de recusa nem NFR de segurança: eles
    inflam a SPEC e antecipam arquitetura.
